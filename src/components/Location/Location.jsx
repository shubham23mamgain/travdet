...
const Location = () => {
  return (
    <>
      <span id="location" className="bg-white dark:bg-black"></span>
      <section data-aos="fade-up" className="">
        <div className="container my-4 bg-white dark:bg-black">
          <h1 className="inline-block border-l-8 border-primary/50 py-2 pl-2 mb-4 text-xl font-bold sm:text-3xl text:black dark:text-white">
            Location to visit
          </h1>
