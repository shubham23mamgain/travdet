...
const Hero = () => {
  ...
  return (
    <div className=" bg-black/20  h-full w-[100%]">
      <div className="h-full flex justify-center items-center p-4 bg-primary/10 dark:bg-yellow">
        <div className="container grid grid-cols-1 gap-4">
          ...
          <div
            data-aos="fade-up"
            data-aos-delay="600"
            className="space-y-4 bg-white dark:bg-black  rounded-md p-4 relative"
          >
            ...
            <button className="bg-gradient-to-r from-primary to-secondary text-white dark:text-black hover:scale-105 px-4 py-2 rounded-full duration-200 absolute -bottom-5 left-1/2 -translate-x-1/2">
              Search Now
            </button>
          </div>
        </div>
